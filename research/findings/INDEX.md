...
94 files, 32.5 MB, 16,538 findings.
...
8.5M tokens, and an agent that opens one of these files has usually spent
...
An entry, with the share of the 16,538 that carry each key:
