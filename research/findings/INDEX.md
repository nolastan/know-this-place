...
89 files, 31.7 MB, 16,155 findings.
...
8.3M tokens, and an agent that opens one of these files has usually spent
...
An entry, with the share of the 16,155 that carry each key:
