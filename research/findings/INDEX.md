...
96 files, 35.1 MB, 17,926 findings.
...
9.2M tokens, and an agent that opens one of these files has usually spent
...
An entry, with the share of the 17,926 that carry each key:
