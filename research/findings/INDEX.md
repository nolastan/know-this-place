...
82 files, 31.0 MB, 15,811 findings.
...
8.1M tokens, and an agent that opens one of these files has usually spent
...
An entry, with the share of the 15,811 that carry each key:
