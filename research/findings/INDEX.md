...
95 files, 33.1 MB, 16,826 findings.
...
8.7M tokens, and an agent that opens one of these files has usually spent
...
An entry, with the share of the 16,826 that carry each key:
