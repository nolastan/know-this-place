...
75 files, 29.5 MB, 15,164 findings.
...
7.7M tokens, and an agent that opens one of these files has usually spent
...
An entry, with the share of the 15,164 that carry each key:
