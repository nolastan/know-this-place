...
101 files, 36.8 MB, 18,852 findings.
...
9.6M tokens, and an agent that opens one of these files has usually spent
...
An entry, with the share of the 18,852 that carry each key:
