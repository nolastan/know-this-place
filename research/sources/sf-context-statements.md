...
>   issue each, and the biographies collection is two more volumes.
...
`biographies-d-f`, and so on. A–C, D–F, G–I, J–L, M–O and P–R are done; S–U and V–Z remain.
