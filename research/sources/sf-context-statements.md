...
`biographies-d-f`, and so on. A–C and D–F are done.
...
- **Verified:** 2026-09-01 (Modern Architecture and Landscape Design: read all
  ...
  **466 findings**; 418 resolved to a parcel, **274 published on 268 pages**,
  144 declined, 48 unresolved. 240 pages seeded, of which 177 carry a fact from
  ...
  construction dates disagree with the assessor.** Of the 144 declined, 78 have
  ...
  the `architecture-preservation-professionals-biographies` collection — and 4
  resolved to parcels with no row on the 2025 secured roll, so no page could be
  seeded. Of the 48 unresolved, 32 are addresses EAS no longer holds, 12 are
