...
>   issue each, and the biographies collection is five more volumes.
...
- **Read into the repo so far:**
  ...
  - San Francisco Planning Department, *Architecture, Planning, and Preservation
    ...
    entry, eight PDFs**: volumes A–C (118 pp.), D–F (56 pp.) and G–I (57 pp.)
    are read; J–L, M–O, P–R, S–U and V–Z are not. Same M-Files vault, one
...
`biographies-d-f`, and so on. A–C, D–F and G–I are done.
