...
| [`digitalsf`](sources/digitalsf.md) | DigitalSF — SF Public Library's catalogued digital archive | catalogued digital archive | high | open | harvested in full: 59,601 records; 2 of 44 collections read whole — SFP 23 (1,165 records → 1,122 findings → 923 on a parcel → 919 on 882 pages) and SFH 371, the Redevelopment Agency Records (2,421 → 421 → 117 → 116 on 103 pages); 42 collections to go, SFP 162 the largest at 1,505 addressed records |
