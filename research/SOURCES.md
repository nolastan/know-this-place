...
| [`cinema-treasures`](sources/cinema-treasures.md) | Cinema Treasures — one page per movie theatre, with its operating history | specialist database | low | reference | consulted per address; 4 of the 15 theatre addresses of #302 have an entry, 3 of them publishable |
...
| [`venue-histories`](sources/venue-histories.md) | Venues' own published histories — the History or About page a theatre, hall or hotel writes about its own building | institutional websites | low | reference | consulted per address; reaches the recent decades the archives stop short of |
