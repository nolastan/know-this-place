...
| [`corbett-heights-neighbors`](sources/corbett-heights-neighbors.md) | Corbett Heights Neighbors newsletter | newsletter | high | open | page 1 of 5 (12 of 50 issues) |
| [`digitalsf`](sources/digitalsf.md) | DigitalSF — SF Public Library's catalogued digital archive | catalogued digital archive | high | open | harvested in full: 59,601 records; 8 of 44 collections read whole — SFP 23 (1,165 records → 1,122 findings → 923 on a parcel → 919 on 882 pages), SFH 371, the Redevelopment Agency Records (2,421 → 421 → 117 → 116 on 103 pages) and SFP 162, the Subjects Photograph Collection, the largest in the repository (34,738 → 1,186 → 662 → 545 on 481 pages, re-read once the caption name filter was fixed and 42 building names recovered onto 28 of them), SFP 22, the Willard E. Worden glass plates of Ingleside Terraces and Jordan Park going up (433 → 77 → 72 → 60 on 59 pages), and the four small buildings collections read together in one run — SFP 42 (Durden slides), SFP 90 (Gordon murals), SFP 125 (Sims, the South of Market hotels before Yerba Buena) and SFP 169 (Martin slides), 1,744 records → 147 findings → 99 resolved → 99 on 88 pages; 36 collections to go and little left in them — **not** SFP 130 or SFP 179 next despite being the largest, because their addressed captions are a newspaper's photographs of named Tenderloin tenants and that needs a decision first (#217); the next buildings run is SFP 84, SFP 103, SFH 3 and SFP 26 together, about 87 addressed records, and then the 1,678 records that carry no citation field at all |
