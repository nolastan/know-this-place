...
| [`nrhp-nominations`](sources/nrhp-nominations.md) | National Register of Historic Places nomination forms | PDF reports | high | open | 54 of 165 San Francisco listings read — every one certified before 1980 — for 56 findings, 30 resolved, 25 published on 21 pages, 6 of them seeded. The listings are indexed everywhere and the forms are not: a nomination's section 8 gives a construction date, the architect or builder and the dated alterations, and the 1974 form revision prints `SPECIFIC DATES` and `BUILDER/ARCHITECT` as adjacent fields. **The address the NPS index carries is not always the address the nomination describes**: nine of the ten listings certified 8 March 1973 are Western Addition Victorians the Redevelopment Agency moved rather than demolished, and the index gives the destination while the form gives where the house stood. Remaining: 111 listings certified 1980 or later, the Civic Center district nomination (78000757, fetched, unread, and absent from the NPS index), and 77000334, whose PDF has no text layer |
