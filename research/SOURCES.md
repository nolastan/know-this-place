...
| [`sf-context-statements`](sources/sf-context-statements.md) | SF Planning historic context statements & surveys | PDF reports | high | open | 18 statements read; ~32 remain (one issue each). All four with findings files are closed out: market-octavia-hcs 425 of 496 published, mission-dolores-hcs 66 of 83, van-ness-auto-row 352 of 453 on 133 pages, carnegie-libraries 1 of 2 |
