...
| [`digitalsf`](sources/digitalsf.md) | DigitalSF — SF Public Library's catalogued digital archive | catalogued digital archive | high | open | harvested in full: 59,601 records; 3 of 44 collections read whole — SFP 23 (1,165 records → 1,122 findings → 923 on a parcel → 919 on 882 pages), SFH 371, the Redevelopment Agency Records (2,421 → 421 → 117 → 116 on 103 pages) and SFP 162, the Subjects Photograph Collection, the largest in the repository (34,738 → 1,186 → 662 → 545 on 481 pages); 41 collections to go, SFP 130 the next at 186 addressed records |
