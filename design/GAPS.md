...
- `2026-09-25` **Phone layout for the address-page map band** — no rule for how far a chip may overlap a map that carries baked-in Mapbox attribution and logo; guessed 1.5rem, and moved Mapbox's credit to an HTML overlay in the top-right corner (mirroring mapbox-gl's attribution control) so no chip covers it. No rule for the band's phone ratio either; guessed 4:3.
