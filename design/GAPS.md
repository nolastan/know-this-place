...
- `2026-09-25` **Phone layout for the address-page map band** — no rule for how far a chip may overlap a map that carries baked-in Mapbox attribution and logo; guessed 1.5rem, which covers both on the 4:3 phone image. No rule for the band's phone ratio either; guessed 4:3.
