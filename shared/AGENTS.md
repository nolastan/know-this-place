...
| *(none — `events/events.json`)* | `.panel-events` in the aside | the events announced on this parcel in the next 30 days — a venue the site documents carries `path`; see [events/AGENTS.md](../events/AGENTS.md) |
